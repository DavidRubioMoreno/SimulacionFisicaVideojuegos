...
public:
	...
	DefaultParticleGenerator(ParticleSystem* sys, ParticleSystem::SolidShape shape, Vector3 pos, ParticleSystem::GeneratorType type = ParticleSystem::GeneratorType::DEFAULT);
	void init() override;
